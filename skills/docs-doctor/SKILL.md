---
name: docs-doctor
description: Read-only docflow diagnosis for any repo. Scans existing docs, config, agent guidance, changelog, placeholders, helper scripts, and broken links; recommends init, adopt, or repair. Use when the user asks "check docs setup", "should I init docflow", "why is docflow not working", "doctor", or "audit documentation setup".
---
